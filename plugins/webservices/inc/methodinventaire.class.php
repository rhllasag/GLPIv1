<?php
/**
 * @version $Id: methodinventaire.class.php 455 2018-06-04 16:27:26Z yllen $
 -------------------------------------------------------------------------
 LICENSE
...
class PluginWebservicesMethodInventaire extends PluginWebservicesMethodCommon {
   ...
   **/
   ...
   static function getItems($protocol, $params=[], $original_params=[]) {
      ...
      $output = [];
      foreach ($dbu->getAllDatasFromTable($table,$sql) as $data) {
   ...
   static function getNetworkports($protocol, $params=[], $original_params=[]) {
      ...
      if ($item->can($params['data']['id'], READ)) {
         ...
         $ports = $dbu->getAllDatasFromTable('glpi_networkports',
   ...
   static function getReservations($protocol, $params=[], $original_params=[]) {
      ...
      foreach ($dbu->getAllDatasFromTable('glpi_reservationitems',
      ...
      $output = [];
      foreach ($dbu->getAllDatasFromTable('glpi_reservations',
