<?php
/**
 * @version $Id: methodcommon.class.php 455 2018-06-04 16:27:26Z yllen $
 -------------------------------------------------------------------------
 LICENSE
...
class PluginWebservicesMethodCommon {
   ...
   **/
   static function methodListDropdownValues($params, $protocol) {
      ...
      $fields = ['name', 'completename', 'comment', 'entities_id', 'is_recursive', 'is_incident',
                 'is_request', 'is_uploadable', 'ext'];
