...
class Computer extends CommonDBTM {
   ...
   **/
   function showForm($ID, $options = []) {
      ...
      echo "<td><label for='textfield_contact_num$rand'>".__('Cedula')."</label></td>";
      echo "<td >";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td><label for='textfield_contact$rand'>".__('Custodio Actual')."</label></td>";
      echo "<td>";
      Html::autocompletionTextField($this, 'contact', ['rand' => $rand]);
      echo "</td>";

      echo "<td><label for='textfield_otherserial$rand'>".sprintf(__('%1$s%2$s'), __('Codigo del Bien'), $tplmark).
           "</label></td>";
      echo "<td>";
      ...
      echo "<td rowspan='$rowspan'><label for='Descripción'>".__('Comments')."</label></td>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td><label for='textfield_uuid$rand'>".__('Código Anterior')."</label></td>";
      echo "<td >";
	  ...
	  // CODIGO INCLUIDO
	  echo "<tr class='tab_bg_1'>";
		echo "<td>".__('Número de Acta/Número de Matriz')."</td>\n";
		echo "<td>";
		Html::autocompletionTextField($this, "Codigo_Anterior");
		echo "</td>";
		echo "<td>".__('Identificador')."</td>\n";
		echo "<td>";
		Html::autocompletionTextField($this, "Identificador");
		echo "</td></tr>\n";
      
     
      echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Modelo/Características')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "mod_carac");
      echo "</td>";
      echo "<td>".__('Color')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Color");
      echo "</td></tr>\n";
      
      
      echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Material')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Material");
      echo "</td>\n";
      echo "<td>".__('Dimensiones')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Dimensiones");
      echo "</td></tr>\n";
        
      echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Habilitado')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Habilitado");
      echo "</td>\n";
      echo "<td>".__('Bodega')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Bodega");
      echo "</td></tr>\n";
      
      echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Custodio Activo')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Custodio_Activo");
      echo "</td>\n";
      echo "<td>".__('Origen del Ingreso')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "OrigenIngreso");
      echo "</td></tr>\n";

            
      echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Condición del Bien')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Condición_Bien");
      echo "</td>\n";
      echo "<td>".__('Tipo de Ingreso')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Tipo_Ingreso");
      echo "</td></tr>\n";
      
      
      echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Nro de Compromiso')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "NCompromiso");
      echo "</td>\n";
      echo "<td>".__('Estado del Acta')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "EstadoActa");
      echo "</td></tr>\n";
      
      echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Contabilizado del Acta')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "ContabilizadoActa");
      echo "</td>\n";
      echo "<td>".__('Contabilizado del Bien')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "ContaBien");
      echo "</td></tr>\n";
      
    echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Item/Reglón')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "ItemReglon");
      echo "</td>\n";
      echo "<td>".__('Cuenta Contable')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "CuentaContable");
      echo "</td></tr>\n";
	  
	  
	  echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Depreciable')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Depreciable");
      echo "</td>\n";
      echo "<td>".__('Ubicación en Bodega')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "UbicBodega");
      echo "</td></tr>\n";
	  
      
	  
	  echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Fecha de Ingreso')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "FIngreso");
      echo "</td>\n";
      echo "<td>".__('Fecha Ultima Depreciación')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Fdepreciacion");
      echo "</td></tr>\n";
	  
	  
	  echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Vida Util')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "VidaU");
      echo "</td>\n";
      echo "<td>".__('Fecha Término Depreciación')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "FTermina");
      echo "</td></tr>\n";
	  
	  echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Valor Contable')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Valorc");
      echo "</td>\n";
      echo "<td>".__('Valos Residual')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Valorr");
      echo "</td></tr>\n";
	  
	  echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Valor en Libros')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Valor_Libros");
      echo "</td>\n";
      echo "<td>".__('Marca')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Marca");
      echo "</td></tr>\n";
