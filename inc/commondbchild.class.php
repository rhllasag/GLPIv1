...
abstract class CommonDBChild extends CommonDBConnexity {
  ...
  static function showChildsForItemFormMV(CommonDBTM $item, $field_name, $canedit = null, $param) {
      global $DB, $CFG_GLPI;
      ...
      if ($canedit) {
         ...
         if ($count == 0) {
            $current_item->getEmpty();
            $current_item->showChildForItemFormMV($canedit, $field_name, -1, $param);
         }
         echo "</div>";
      }
   }
	function showChildForItemFormMV($canedit, $field_name, $id, $param) {
