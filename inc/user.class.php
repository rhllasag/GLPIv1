...
//nombres
      ...
      echo "<tr class='tab_bg_1'><td><label for='textfield_firstname$firstnamerand'>" . __('Puesto') . "</label></td><td>";
      Html::autocompletionTextField($this, "firstname", ['rand' => $firstnamerand, 'value'=>$n_puesto]);
      echo "</td></tr>";
...
//CEDULA 
      $phonerand = mt_rand();
      echo "<tr class='tab_bg_1'>";
      echo "<td><label for='textfield_phone$phonerand'>" .  __('Cedula/Pasaporte') . "</label></td><td>";
      ...
      echo "<tr class='tab_bg_1'>";
//TELEFONO
      echo "<td><label for='textfield_mobile$mobilerand'>" . __('Telefono') . "</label></td><td>";
      Html::autocompletionTextField($this, "mobile", ['rand' => $mobilerand,'value'=>$telefono_banner]);
      echo "</td>";
      $catrand = mt_rand();
...
//TELEFONO EXTENCION
      ...
      Html::autocompletionTextField($this, "registration_number", ['rand' => $admnumrand, 'value'=>$ext_banner]);
      echo "</td></tr>";
