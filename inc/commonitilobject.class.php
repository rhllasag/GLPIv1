...
abstract class CommonITILObject extends CommonDBTM {
   ...
   **/
   static function getImpactName($value) {
      ...
      switch ($value) {
         case 5 :
            return _x('impact', 'Crítica: RECTORADO/VICERRECTORADO');

         case 4 :
            return _x('impact', 'Alta:GERENCIAS/FINANZAS/LOGISTICA/ADMISION Y REGISTRO/ASESORES');

         case 3 :
            return _x('impact', 'Media:DOCENTES/ALUMNOS/UNIDADES/CARRERAS/CENTROS DE APOYO');

         case 2 :
            return _x('impact', 'Baja:SEDES/LABORATORIOS/BIBLIOTECA');

         case 1 :
            return _x('impact', 'Muy Baja');
