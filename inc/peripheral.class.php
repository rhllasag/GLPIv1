...
class Peripheral extends CommonDBTM {
   ...
   **/
   function showForm($ID, $options = []) {
     ...
     echo "<td>";
     echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Código Anterior')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Código_Anterior");
      echo "</td>";
     ...
     echo "</td></tr>\n";
      ...
      echo "<td>";
      Html::autocompletionTextField($this, "Modelo_Características");
      echo "</td>";
      echo "<td>".__('Color')."</td>\n";
      echo "<td>";
      ...
      echo "<td>";
      Html::autocompletionTextField($this, "Origen_Ingreso");
      echo "</td></tr>\n";
      ...
      echo "<td>";
      Html::autocompletionTextField($this, "Nro_Compromiso");
      echo "</td>\n";
      echo "<td>".__('Estado del Acta')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Estado_Acta");
      echo "</td></tr>\n";
      
      echo "<tr class='tab_bg_1'>";
      echo "<td>".__('Contabilizado del Acta')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Contabilizado_Acta");
      echo "</td>\n";
      echo "<td>".__('Contabilizado del Bien')."</td>\n";
      echo "<td>";
      Html::autocompletionTextField($this, "Contabilizado_Bien");
      echo "</td></tr>\n";
